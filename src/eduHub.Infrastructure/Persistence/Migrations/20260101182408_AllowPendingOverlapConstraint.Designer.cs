...
namespace eduHub.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260101182408_AllowPendingOverlapConstraint")]
    partial class AllowPendingOverlapConstraint
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eduHub.Domain.Entities.AvailabilityBlackout", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("OrganizationId", "StartTimeUtc")
            ...
            modelBuilder.Entity("eduHub.Domain.Entities.BuildingAvailabilityWindow", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("eduHub.Domain.Entities.RoomAvailabilityWindow", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("room_availability_windows", (string)null);
                });

            modelBuilder.Entity("eduHub.Domain.Entities.TenantResolveToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("tenant_resolve_tokens", (string)null);
                });
